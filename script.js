...
function render(){
 ...
 $('price-chart').innerHTML=`<svg viewBox="0 0 300 75" preserveAspectRatio="none" role="img" aria-label="最近30个交易日收盘价格趋势"><defs><linearGradient id="fill" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#c4d9a1" stop-opacity=".19"/><stop offset="1" stop-color="#c4d9a1" stop-opacity="0"/></linearGradient></defs><path d="M0,75 L${points.replaceAll(' ',' L')} L300,75 Z" fill="url(#fill)"/><polyline points="${points}" fill="none" stroke="#cee1ae" stroke-width="1.7" vector-effect="non-scaling-stroke"/></svg>`;
